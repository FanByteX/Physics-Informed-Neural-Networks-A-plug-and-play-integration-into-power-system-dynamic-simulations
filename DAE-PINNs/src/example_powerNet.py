...
def main(args):
    ...
    if use_cuda:
        torch.cuda.set_device(0)  # 使用 GPU 0（系统只有一个 GPU）
    ...
    model_config = {
        ...
        'dyn_activation': args.dyn_activation,
        'dyn_type': args.dyn_type,
        'dyn_bn': args.dyn_bn,
        'dyn_ln': args.dyn_ln,
        'alg_width': args.alg_width,
        'alg_depth': args.alg_depth,
        'alg_activation': args.alg_activation,
        'alg_type': args.alg_type,
        'alg_bn': args.alg_bn,
        'alg_ln': args.alg_ln,
        'dropout_rate': args.dropout_rate,
        'dyn_state_dim': 4,  # dynamic.state_dim
    }
...
if __name__ == "__main__":
    ...
    # optimizer
    parser.add_argument('--use-tqdm', action='store_true', default=True, help="enable tqdm progress bar for training")
